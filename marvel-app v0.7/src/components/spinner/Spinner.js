...
const Spinner = () => {
    ...
    return (
        <div className="spiner">
            <svg viewBox="0 0 100 100" width="100" height="100" stile={{background: "none", margin: "0 auto", display: "block"}} >
                <circle cx="100" cy="100" r="100" strokeWidth="5" stroke="#fff" fill="transparent"/>
                <path d="M50 20
                        A 30 30 0 1 1 50 80
                        A 30 30 0 1 1 50 20
